...
public class MobileNetworkSettings extends PreferenceActivity
        ...
        if (mGsmUmtsOptions != null &&
            ...
            return true;
             ...
             android.provider.Settings.Global.putInt(mPhone.getContext().getContentResolver(),
                 android.provider.Settings.Global.MVNO_ROAMING, mButtonNationalDataRoam.isChecked() ? 1 : 0);
	    return true;
    ...
    protected void onResume() {
        ...
        mButtonNationalDataRoam.setChecked(android.provider.Settings.Global.getInt(
             mPhone.getContext().getContentResolver(), android.provider.Settings.Global.MVNO_ROAMING, 0) == 1);
